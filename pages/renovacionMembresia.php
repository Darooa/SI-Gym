                ...
                <div class="col-md-10">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <label for="example-text-input" class="form-control-label">Nombre del cliente:</label>
                                        <span><strong>Nombre del cliente: </strong> <?php echo $nombre ?></span>
                            ...
                            <div class="row">
                                <button class="btn btn-primary btn-sm ms-auto ">Renovar Membresía</button>
                            </div>
                        </div>
                    </div>
                </div>
...
$(document).ready(function () {
    ...
    $("#fechaInicio").val(`${año}-${mes}-${dia}`);

    // Evento select2
    $('#tipoMembresia').on('select2:select', function (e) {
