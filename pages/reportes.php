      ...
      <div class="row mt-4">
        ...
        <script>
            ...
            <div class="card-header pb-0 p-3">
              <button type="button" class="turno1 btn btn-secondary btn-sm">Turno 1</button>
              <button type="button" class="turno2 btn btn-secondary btn-sm">Turno 2</button>
              <button type="button" class="completo btn btn-secondary btn-sm">Completo</button>
              <button class="btn btn-icon btn-sm btn-secondary" type="button" id="datepicker">
                <span class="btn-inner--icon"><i class="ni ni-calendar-grid-58"></i></span>
              </button>
              <button class=" generatepdf btn btn-icon btn-sm btn-secondary" type="button">
            ...
            <h4 class="text-center text-uppercase text-dark text-sm font-weight-bolder opacity-7"
              style="text-align: end;" id="suma"></h4></div>
          </div>
        </div>
      </div>
      <!------------------------------------------------------------------------------>
  ...
  <div class="fixed-plugin">
    ...
    <div class="card shadow-lg">
      ...
      <div class="card-body pt-sm-3 pt-0 overflow-auto">
        ...
        <p class="text-sm d-xl-none d-block mt-2">Puede cambiar el tipo de navegación lateral solo en la vista de
          escritorio.</p>
        <!-- Navbar Fixed -->
